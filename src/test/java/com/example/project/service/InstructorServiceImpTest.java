...
//                () -> instructorService.addWorkoutToInstructor(workoutClassEntity, instructorEntity));
//
//        assertEquals("This instructor already signed for: " + workoutClassEntity.getName(), exception.getMessage());
//    }
//
//    @Test
//    @Transactional
//    void shouldGetInstructorById() {
//        WorkoutClassEntity workoutClassEntity = new WorkoutClassEntity("asd", durationTest, true, 100);
//        InstructorEntity instructorEntity =
...
//                "Alex", "Boch", passport,
//                LocalDate.of(1989, 1, 1), true);
//        WorkoutClassEntity workoutClassEntity = new WorkoutClassEntity("crossfit", durationTest, true, 100);
//        instructorService.addWorkoutToInstructor(workoutClassEntity, instructorEntity);
//        instructorRepo.save(instructorEntity);
//
